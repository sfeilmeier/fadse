 ...
 * <code>Comparator</code> (a method for comparing
...
public class CrowdingComparator implements Comparator {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        SolutionSet set = MetricsUtil.readPopulation("D:\\Work\\Doctorat\\Output\\FADSE\\nsgaii\\problem1367141145424.csv", 100, 2);
        try {
            set.sort(new ObjectiveComparator(0));
            set.sort(new ObjectiveComparator(1));
        } catch (Exception ex) {
