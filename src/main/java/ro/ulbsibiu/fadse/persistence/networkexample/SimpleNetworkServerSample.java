...
public class SimpleNetworkServerSample
{
	...
	private static void startWithProperty() throws Exception
	{
		...
		System.setProperty("derby.drda.startNetworkServer","true");
                System.setProperty("derby.drda.host","172.16.8.69");
		// Booting derby
		Class.forName("org.apache.derby.jdbc.EmbeddedDriver").newInstance();
	}
	...
	private static String ijUsage()
	{
		...
		ijUsage +=  "\t$ java -Dij.user=me -Dij.password=pw -Dij.protocol=jdbc:derby://172.16.8.69:1527/ org.apache.derby.tools.ij\n";
